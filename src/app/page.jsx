        ...
        <section className="min-h-screen">
          ...
          <div className="text-center p-10">
            ...
            <p className="text-md py-5 leading-8 text-gray-800 md:text-xl max-w-xl mx-auto dark:text-gray-200">
              Are you in need of expert assistance for your programming and
              design projects? Look no further! Join me and let's work together
              to bring your ideas to life in a dynamic and exciting way!
            </p>
          </div>
          <div className="text-5xl flex justify-center gap-16 py-3 text-gray-600 dark:text-gray-300">
            <div className="cursor-pointer transition ease-in-out delay-150 hover:-translate-y-1">
              <AiFillTwitterCircle />
            </div>
            <div className="cursor-pointer transition ease-in-out delay-150 hover:-translate-y-1">
              <AiFillLinkedin />
